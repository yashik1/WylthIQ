...
export const METRIC_GUIDE: Readonly<Record<MetricGuideId, MetricGuide>> = {
  revenue: {
    ...
    limits: "It says nothing about profit — a company can grow sales while losing more money on each one — and an acquisition can add revenue without the business itself growing.",
    source: FROM_FILINGS,
  },
  "gross-margin": {
    id: "gross-margin",
  ...
  "net-margin": {
    ...
    limits: "One-off items — a legal settlement, a tax charge, selling a division — move it without the business changing.",
    source: FROM_FILINGS,
  },
  "free-cash-flow": {
    id: "free-cash-flow",
  ...
  pe: {
    ...
    why: "It is the most common shorthand for how much growth the market is already expecting.",
  ...
  piotroski: {
    ...
    why: "Published by Joseph Piotroski in 2000 as a quick test of financial strength and direction.",
  ...
  altman: {
    ...
    how: "A weighted sum of working capital, retained earnings, operating profit, market or book value and sales, each against total assets. The weights depend on which of Altman's variants applies.",
